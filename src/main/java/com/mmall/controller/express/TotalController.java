...
public class TotalController {
    ...
    public Result<IPage<Total>> getList(Page page, @RequestParam("date")String date) throws ParseException {
    ...
    public Map<String, String> set(MultipartFile file,@RequestParam("time") String time) throws Exception {
        return xlsxProcessAbstract.processAllSheet(file,time);
    }
